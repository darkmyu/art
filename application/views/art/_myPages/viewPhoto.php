...
<div class="container-fluid mt-5">
	...
	<div class="row justify-content-center">
		<div class="col-md-7 mb-4" data-aos='fade'>
			<div class="row mb-4">
				<div class="col-12">
					<h2	h2 class="site-section-heading text-center">My Photos</h2>
					<form name="form1">
						<div class="text-center">
							...
							<?
								...
								echo("<a href='/~sale11/art/my/viewPhoto' class='text-white font-weight-bold'>#&nbsp모두&nbsp</a>");
								echo("</button>");

								foreach ($gallerys as $row1) {
									echo("<button class='btn-sm mx-1 px-2 mt-2' style='background-color: #3b3b3b; border: none;'>");
									echo("<a href='/~sale11/art/my/viewPhoto/text1/$row1->name11' class='text-white font-weight-bold'>#&nbsp$row1->name11&nbsp</a>");
									echo("</button>");
								}
							?>
						</div>
							...
							<div class='col-sm-6 col-md-4 col-lg-3 col-xl-3 item' data-aos='fade'>	
									...
									<div class='image-wrap-2'>
										<div class='image-info'>
											<a href='/~sale11/art/my/editPhoto/text1/$row->no11' class='btn btn-outline-white py-2 px-4 font-weight-bold'>수정</a>
										</div>
...
<script>
	function find_text() {
		if (!form1.text1.value) {
			form1.action = "/~sale11/art/my/viewPhoto";
		} else {
			form1.action = "/~sale11/art/my/viewPhoto/text1/" + form1.text1.value;
		}
	}
</script>