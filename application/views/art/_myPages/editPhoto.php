		...
		<div class="row justify-content-center">
			<div class="col">
				<div class="row" style="margin-bottom: 4rem">
					<div class="col-12">
						<h2 class="site-section-heading text-center">My Photo Edit</h2>
						<hr class="bg-white">
					</div>
				</div>
			</div>
				...
				<form name="form1" action="" method="post" enctype="multipart/form-data">
					<div class="row form-group">
						<div class="col-12 text-dark">
							...
							<input type="text" id="title" name="title" value="<?= $row->title11 ?>" class="form-control font-weight-bold
						...
						<div class="col-12 mt-4">
							...
							<textarea name="content" id="content" cols="30" rows="7" class="form-control font-weight-bold" placeholder="여러분들의 이야기를 포함시켜보세요!"><?= $row->content11 ?></textarea>
							<? 
								...
								<?
									...
									foreach ($gallerys as $row1) {
										if ($row1->no11 == $row->gallery_no11) {
											echo("<option value='$row1->no11' selected class='text-dark font-weight-bold'>$row1->name11</option>");
										} else {
											echo("<option value='$row1->no11' class='text-dark font-weight-bold'>$row1->name11</option>");
										}
									}
								?>
							</select>
						...
						<div class="col-12 my-2" id="image_container">
								<img src="/~sale11/img/picture/<?= $row->pic11 ?>" class="img-fluid" id="check">
						</div>
						...
						<div class="col-md-12 mt-2 text-right">
							<a href="/~sale11/art/my/deletePhoto/no/<?= $row->no11 ?>" class="btn bg-danger text-white py-2 px-4" onClick="return confirm('<?= $row->title11?>, 삭제할까요?');">
								Delete
							</a>
							<input type="submit" value="Update Photo" class="btn btn-primary py-2 px-4 text-white">
						</div>
					</div>
				</form>
			</div>
